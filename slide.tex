...
\label{sec:org5c1c5a3}
\subsection{motivated examples}
\label{sec:org8fbbe3a}
\begin{frame}[label={sec:org14e10b7}]{Graph Structure Analysis}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf222872}]{Motivated Problem}
\begin{columns}
...
\label{sec:org58316c3}
\begin{frame}[label={sec:org14aa9e8}]{Running Example}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgdf331e3}]{Adjacency Matrix}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org5cd6b61}]{Google Matrix}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orge6f7f66}]{}
\begin{columns}
\begin{column}{0.6\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org110e183}]{}
\begin{columns}
\begin{column}{0.6\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org50b4832}]{Property of Stationary Distribution}
\begin{columns}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org3f0a7b5}]{}
\begin{columns}
\begin{column}{0.6\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orged49117}]{Property of Scaling (\(\alpha\))}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\(\alpha=0.85\)\\
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgde98276}]{}
\begin{columns}
\begin{column}{0.6\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org1f163cb}]{Property of Sink Node}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2df6b82}]{Applications}
...
\label{sec:org730e2c2}
\subsection{time-varying graph and transition matrix}
\label{sec:org4c88a26}
\begin{frame}[label={sec:org8eff03d}]{Time-Varying Graph}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org78922e5}]{}
\begin{columns}
\begin{column}{0.6\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org8d303dd}]{}
\begin{center}
\onslide*<1>{
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org5addf93}]{}
\begin{columns}
\begin{column}{0.6\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org81829b5}]{}
\begin{center}
\onslide*<1>{
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgd2061c3}]{}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\label{sec:orgd8048e4}
\begin{frame}[label={sec:org5d28fb0}]{Our Problem}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org5c44383}]{}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orge6f76de}]{Restriction of Eigenvector}
...
\label{sec:orgd57e87f}
\subsection{real-world data analysis}
\label{sec:org7790dac}
\begin{frame}[label={sec:orgad06acd}]{Automobile Sales Data}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org3c61c73}]{}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org391ba22}]{}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org5ab35e6}]{}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org306e0d1}]{Graph Visualization}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
2007-1Q\\
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgbfadabd}]{}
\begin{center}
% 2007\\
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgedcf47a}]{}
\begin{center}
% 2008/2009\\
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org4e81cd1}]{}
\begin{center}
% 2013\\
\includegraphics[page=11,
...
\end{frame}
\section{Conclusion}
\label{sec:org0939f0a}
\begin{frame}[label={sec:org047aef0}]{Concluding Remarks}
