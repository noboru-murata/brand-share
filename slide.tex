...
\label{sec:org7efa3c1}
\subsection{motivated examples}
\label{sec:org3c5cfaf}
\begin{frame}[label={sec:org7cc2af4}]{Graph Structure Analysis}
two problems in graph inference:
\begin{itemize}
\item \alert{direct problem (deductive)}: \\
...
\label{sec:orgad6de36}
\begin{frame}[label={sec:org6ff196c}]{Running Example}
\begin{columns}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgb10e805}]{Adjacency Matrix}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgb2f7add}]{Google Matrix}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1cdc01d}]{}
\begin{columns}
\begin{column}{0.6\columnwidth}
...
\begin{itemize}
\item \(\alpha=0.85\)
\item initial: uniform dist.
\end{itemize}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:orga652e7a}]{}
\begin{columns}
\begin{column}{0.6\columnwidth}
...
\begin{itemize}
\item \(\alpha=0.85\)
\item initial: 12 nodes
(randomly selected)
\end{itemize}
\end{column}
\end{columns}
\end{frame}
\begin{frame}[label={sec:org508c937}]{Property of Stationary Distribution}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
initial condition 1\\
\includegraphics<1>[page=12,width=.9\linewidth]{statdist}%
\includegraphics<2>[page=13,width=.9\linewidth]{statdist}%
\end{center}
\end{column}
\begin{column}{0.5\columnwidth}
\begin{center}
initial condition 2\\
\includegraphics<1>[page=25,width=.9\linewidth]{statdist}%
\includegraphics<2>[page=26,width=.9\linewidth]{statdist}%
\end{center}
\end{column}
\end{columns}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgaa0bd61}]{}
\begin{columns}
\begin{column}{0.6\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgdb90757}]{Property of Scaling (\(\alpha\))}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
\(\alpha=0.85\)\\
...
\begin{center}
\(\alpha=0.5\)\\
\includegraphics<1>[page=38,width=.9\linewidth]{statdist}%
\includegraphics<2>[page=39,width=.9\linewidth]{statdist}%
\end{center}
\end{column}
\end{columns}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org1555ff2}]{}
\begin{columns}
\begin{column}{0.6\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgeb88742}]{Property of Sink Node}
\begin{columns}
\begin{column}{0.5\columnwidth}
\begin{center}
...
\includegraphics<1>[page=51,width=.9\linewidth]{statdist}%
\includegraphics<2>[page=52,width=.9\linewidth]{statdist}%
\end{center}
\end{column}
\end{columns}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgc473165}]{Applications}
...
\label{sec:orge18face}
\subsection{time-varying graph and transition matrix}
\label{sec:org262f61c}
\begin{frame}[label={sec:orga79b0f6}]{Time-Varying Graph}
...
\begin{itemize}
\item frequent update (fast time scale; \(t\))\\
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org55c4ecb}]{}
\begin{columns}
\begin{column}{0.6\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org94aee3e}]{}
\begin{center}
\onslide*<1>{
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org461aa1f}]{}
\begin{columns}
\begin{column}{0.6\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org56b96d9}]{}
\begin{center}
\onslide*<1>{
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org70e6b2e}]{}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
...
\label{sec:orgd61ee19}
\begin{frame}[label={sec:orgd861def}]{Our Problem}
...
\end{equation}
\end{frame}
\begin{frame}[label={sec:org3317f07}]{}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgc948180}]{Restriction of Eigenvector}
...
\label{sec:org871e20c}
\subsection{real-world data analysis}
\label{sec:org51336c9}
\begin{frame}[label={sec:org626a644}]{Automobile Sales Data}
\begin{block}{Reference}
\citeauthor{Chiba_etal_2017_TimeVaryingTransitionProbability}
\citetitle{Chiba_etal_2017_TimeVaryingTransitionProbability}
\end{block}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org968f5be}]{}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org6f3b207}]{}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgfc70757}]{}
\begin{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orga5b4117}]{Graph Visualization}
\begin{columns}
\begin{column}{0.6\columnwidth}
\begin{center}
2007-1Q\\
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgffeced3}]{}
\begin{center}
% 2007\\
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org82c8703}]{}
\begin{center}
% 2008/2009\\
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org66cacb1}]{}
\begin{center}
% 2013\\
\includegraphics[page=11,
...
\end{frame}
\section{Conclusion}
\label{sec:orgfa671d2}
\begin{frame}[label={sec:org2586ecd}]{Concluding Remarks}
